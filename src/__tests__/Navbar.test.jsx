...
describe("Navigation Links", () => {
  it("has correct href attributes for navigation links", () => {
    ...
    const shopLink = screen.getAllByText(/Shop/i)[0].closest("a");
    const basketLink = screen.getAllByText(/Basket/i)[0].closest("a");
    const aboutLink = screen.getAllByText(/Who we are/i)[0].closest("a");
